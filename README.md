...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-session-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15495&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-session-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-session` can be installed with:

```
conda install r-session
```

It is possible to list all of the versions of `r-session` available on your platform with:
